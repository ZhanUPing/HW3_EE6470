...
void SobelFilter::do_filter()
{
  ...
  unsigned char temp_r[9] = {0};
  unsigned char temp_g[9] = {0};
  unsigned char temp_b[9] = {0};

  /*3333*/
  while (true)
  {

    unsigned char buffer_r[6] = {0};
    unsigned char buffer_g[6] = {0};
    unsigned char buffer_b[6] = {0};
/*444*/
    avg_r = 0;
    avg_g = 0;
    avg_b = 0;
